...
variable "external_ids" {
  description = "External IDs that will be used to assume the role. Segment will currently use the Workspace ID as the external ID when connecting to your AWS account, and this should be a list of IDs of the Workspaces that you want to connect to your Data Lake. These IDs are generated by Segment and can be retrieved from "Settings -> Workspace settings" in the Segment app."
  type        = list(string)
}
